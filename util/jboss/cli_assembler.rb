module CliAssembler
  def assemble_address(resource)
    ...
    escaped_resource = resource.gsub(%r{\\\/}, escaped_slash)
  ...
  def assemble_operation(operation)
    ...
    operation_name = Regexp.last_match(1) if operation =~ /^([\w\-]+)$/
    ...
    assembled_operation[:name] = attribute_name unless attribute_name.nil?

    assembled_operation.merge! assemble_attributes(params) unless params.nil?
